...
public class FirstController {
	...
	/*
	 * @GetMapping("/get/{bookId}") public String handleViewBook(@PathVariable int
	 * bookId, Model model) { Optional<Book> b1 = brepo.findById(bookId);
	 * model.addAttribute("title", b1.get().getTitle()); return "view"; }
	 * 
	 */
